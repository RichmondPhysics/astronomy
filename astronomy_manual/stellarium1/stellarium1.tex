...
to the Appendix for details about how to do these things.
...
Set the date to some time around today's date, and the time to around 9 pm.
...
In the winter, the other easy constellation to spot is Orion.
Set the date to some time in the winter, and find
